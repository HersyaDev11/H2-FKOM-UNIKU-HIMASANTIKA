          ...
          >
            {slides.map((slide, index) => (
              <div
                ...
                className={cn(
                  "absolute left-1/2 top-0 aspect-square overflow-hidden rounded-2xl sm:rounded-3xl bg-neutral-900 shadow-2xl will-change-transform border border-white/10 transition-shadow",
                  cardClassName,
                )}
      ...
      {showCaption && (
        ...
        >
          ...
          <div className="min-h-[34px] sm:min-h-[38px] md:min-h-[42px] flex items-center justify-center w-full max-w-2xl">
            <p className="text-[19px] sm:text-[23px] md:text-[25px] font-normal tracking-tight text-[#FFFFFF] text-center px-2 transition-opacity duration-200">
              {active?.title || ""}
            </p>
          </div>
          ...
          {/* Symmetrical Metadata Table (Consistent 3 rows) */}
